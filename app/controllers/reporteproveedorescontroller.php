...
class ReporteProveedoresController extends Controller {
    ...
    public function getReporte(){
        ...
        $registros=$this->proveedor->getProveedorReporte($_GET);
        //Encabezado informe
        ...
        $html.="<th colspan='5' style='padding: 10px; border: 1px solid #999; text-align: center; background-color: #000; color: #fff;font-size: 18px;'>Proveedores de El Cerrito </th></tr><tr>";
        $html.="<th colspan='1' style='padding: 10px; border: 1px solid #999; text-align: center; background-color: #000; color: #fff;'>Id</th>";
        $html.="<th colspan='1' style='padding: 10px; border: 1px solid #999; text-align: center; background-color: #000; color: #fff;'>Proveedor</th>";
        $html.="<th colspan='1' style='padding: 10px; border: 1px solid #999; text-align: center; background-color: #000; color: #fff;'>Contacto</th>";
        $html.="<th colspan='1' style='padding: 10px; border: 1px solid #999; text-align: center; background-color: #000; color: #fff;'>Producto</th>";
        $html.="<th colspan='1' style='padding: 10px; border: 1px solid #999; text-align: center; background-color: #000; color: #fff;'>Categoria</th>";
        $html.="</tr></thead><tbody>";
        $total=0;
