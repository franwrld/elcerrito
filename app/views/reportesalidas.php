<?php 
    $title = "Reporte Salidas";
    include_once "app/views/sections/headhtml.php";
?>
<!-- CSS -->
<link rel="stylesheet" href="<?php echo URL;?>public_html/css/reportesalidas.css">
<body>
...
<script src="<?php echo URL;?>public_html/customjs/reportesalidas.js"></script>
</body>
</html>