...
?>
<!-- CSS -->
<link rel="stylesheet" href="<?php echo URL;?>public_html/css/reporteproveedores.css">
<body>
 ...
 <div class="contenedor">
    ...
    <div class="continformes">
        <label class="labelReportes" for="autoSizingInput">Proveedor:</label>
...
<script src="<?php echo URL;?>public_html/customjs/reporteproveedores.js"></script>
</body>
</html>